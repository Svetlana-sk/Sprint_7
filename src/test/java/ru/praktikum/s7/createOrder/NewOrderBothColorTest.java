...
public class NewOrderBothColorTest {
    ...
    public NewOrderBothColorTest(String customerFirstName, String customerLastName, String address, int metroStation, String phone, int rentTime, String deliveryDate, String comment) {
    ...
    @Test
    public void createOrderBothColor() {
        ...
        // Шаг 2: Создание заказа с двумя цветами
        createOrder();
    ...
    @Step("Шаг 2: Создание заказа с двумя цветами")
