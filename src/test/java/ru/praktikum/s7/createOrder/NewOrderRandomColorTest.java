...
public class NewOrderRandomColorTest {
    ...
    public NewOrderRandomColorTest(String customerFirstName, String customerLastName, String address, int metroStation, String phone, int rentTime, String deliveryDate, String comment) {
    ...
    @Test
    public void createOrderRandomColor() {
        ...
        // Шаг 2: Создание заказа со случайным цветом
        createOrder();
    ...
    @Step("Шаг 2: Создание заказа со случайным цветом")
